        ...
        <div className='bg-orange-100 m-2 sm:m-4 block w-[250px] border border-black rounded-sm'>
          ...
          <form className='w-full' onSubmit={handleSubmit}>
            ...
            <div className='w-full flex justify-center'>
              <img className='h-[80px] w-[80px] mb-1 border-[2px] rounded-md' src={formData.preview} alt="Preview" />
            </div>
            <button className='bg-green-300 h-[40px] w-[200px] rounded-md border-[2px] mb-3 border-black' type='submit'>Update</button>
          </form> 
        </div>
      </div>
    </div>
